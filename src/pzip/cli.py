...
def copy(infile, outfile, progress=None):
    """
    Copies infile to outfile in chunks, optionally updating a progress bar. Closes
    infile and outfile upon completion, if they are not interactive.
    """
...
def main(*args):
    ...
    parser.add_argument(
        "-z", "--compress", action="store_true", default=False, help="force compression"
    )
    parser.add_argument(
        "-d",
        "--decompress",
    ...
    parser.add_argument(
        "-k", "--keep", action="store_true", default=False, help="keep input files"
    )
    parser.add_argument(
        "-c",
        "--stdout",
        action="store_true",
        default=False,
        help="write to stdout (implies -kq)",
    )
    parser.add_argument(
        "-f",
        "--force",
    ...
    parser.add_argument(
        ...
        "--auto",
        action="store_true",
        help="automatically generate and output a key",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="extract only, no decompression",
    )
    parser.add_argument(
        "-q", "--quiet", action="store_true", default=False, help="no output"
    )
    parser.add_argument(
        "-l",
        "--list",
        action="store_true",
        default=False,
        help="print information about the specified files",
    )
    parser.add_argument(
        "files", metavar="file", nargs="*", help="files to encrypt or decrypt"
    )
